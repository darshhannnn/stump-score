      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold text-blue-900 dark:text-blue-300 mb-2">Premium Dashboard</h1>
              <p className="text-gray-600 dark:text-gray-400">Welcome back, {user?.name || 'Premium User'}</p>
            </div>
            
            {subscriptionDetails && (
              <div className="mt-4 md:mt-0 card py-2 px-4 text-sm">
          ...
          {error && (
            <div className="bg-red-100 dark:bg-rose-500/10 border-l-4 border-red-500 text-red-700 dark:text-rose-400 p-4 mb-8" role="alert">
              <p>{error}</p>
            </div>
          )}
          ...
          <div className="card overflow-hidden mb-8">
            ...
            <div className="p-6">
              {activeTab === 'overview' && (
                <div>
                  <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4">Your Premium Overview</h2>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <ul className="divide-y divide-gray-200 dark:divide-gray-700">
                          <li className="py-3">
                            <div className="flex items-start">
                              <div className="flex-shrink-0 bg-blue-100 dark:bg-blue-500/15 rounded-full p-1">
                              ...
                              <div className="ml-3">
                                <p className="text-sm font-medium text-gray-800 dark:text-gray-100">Premium activated</p>
                          ...
                          <li className="py-3">
                            <div className="flex items-start">
                              <div className="flex-shrink-0 bg-green-100 dark:bg-emerald-500/10 rounded-full p-1">
                                <svg className="w-5 h-5 text-green-600 dark:text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                                </svg>
                              </div>
                              <div className="ml-3">
                                <p className="text-sm font-medium text-gray-800 dark:text-gray-100">New prediction available</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400">Yesterday at 6:45 PM</p>
                              </div>
                            </div>
                          </li>
                          <li className="py-3">
                            <div className="flex items-start">
                              <div className="flex-shrink-0 bg-purple-100 dark:bg-purple-500/10 rounded-full p-1">
                              ...
                              <div className="ml-3">
                                <p className="text-sm font-medium text-gray-800 dark:text-gray-100">Stats updated</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400">May 30, 2025</p>
                              </div>
                            </div>
                          </li>
                        </ul>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">Featured Match Prediction</h3>
                        ...
                        <div className="p-4">
                          <div className="flex justify-between items-center mb-4">
                            <div className="flex flex-col items-center">
                              <span className="text-sm font-medium text-gray-800 dark:text-gray-100 mb-1">India</span>
                              <div className="w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center text-xl">🇮🇳</div>
                            </div>
                            <div className="text-center">
                              <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">Match Prediction</div>
                              <div className="flex items-center space-x-2">
                                ...
                                <div className="w-10">
                                  <span className="text-sm font-bold text-yellow-600 dark:text-amber-400">22%</span>
                                </div>
                              </div>
                            </div>
                            <div className="flex flex-col items-center">
                              <span className="text-sm font-medium text-gray-800 dark:text-gray-100 mb-1">Australia</span>
                              <div className="w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center text-xl">🇦🇺</div>
                            </div>
                          </div>
